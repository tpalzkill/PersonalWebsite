Vue.component('static-projects', {
    ...
    <div class="tile">
      <div class="tile is-parent is-vertical">
        <article data-aos="fade-down-right"class="tile is-child box">
        ...
        <article data-aos="fade-right" class="tile is-child box">
      ...
      <div class="tile is-parent">
        <article data-aos="fade-down" class="tile is-child box">
    ...
    <div class="tile is-parent">
      <article data-aos="fade-up-right" class="tile is-child box">
    ...
    <div class="tile is-parent">
    <article data-aos="fade-left" class="tile is-child box">
