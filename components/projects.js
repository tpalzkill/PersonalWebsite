Vue.component('static-projects', {
    ...
    <div class="tile">
      <div class="tile is-parent is-vertical">
        <article data-aos="fade-down-right" data-aos-duration="1300" class="tile is-child box">
        <a href='https://github.com/tpalzkill/killbase-app'>
        <p class="title">KillBase</p>
        <p class="subtitle">December 2017</p>
        </a>
        <p>A Galvanize assignment and my first full-stack app, KillBase is a fictional contract killing platform. Clients can take out contracts on targets, which assassins will then be able to accept. As- sassins can only take contracts if they satisfy the requisite \"sKILL Level
        \". At any time an assassin can become a target or a client.</p>
        </article>
        <article data-aos="fade-right" data-aos-duration="1300" class="tile is-child box">
        <a href='https://radlibs.surge.sh/'>
      ...
      <div class="tile is-parent">
        <article data-aos="fade-down" data-aos-duration="1300" class="tile is-child box">
        <a href='https://github.com/tpalzkill/radspots'>
        ...
        <figure id='radspotspicture' class="image">
        <img src='static/img/edit-profile.png' id='radspots'/>
        </figure>
        </article>
      </div>
    </div>
    <div class="tile is-parent">
      <article data-aos="fade-up-right" data-aos-duration="1300" class="tile is-child box">
      <a href='https://github.com/tpalzkill/Rad-Crawls'>
    ...
    <div class="tile is-parent">
    <article data-aos="fade-left" data-aos-duration="1300" class="tile is-child box">
    <a href='https://github.com/LanceHunter/Capstone-Game'>
